...
export default function MountingPlanner() {
  ...
  const handleDownloadSopPdf = () => {
    ...
    doc.setFontSize(14);
    doc.text("MotorMedic Pro Official Installation SOP", margin, 12);
    doc.setFontSize(9);
    ...
    doc.text("Generated by MotorMedic Pro • ISO 20816 installation verification record.", margin, y);

    doc.save(`MotorMedic-SOP-${assetTag}.pdf`);
              ...
              <div className="flex items-start justify-between gap-3">
                <div className="min-w-0 space-y-1.5">
                  <p className="text-[11px] font-bold uppercase tracking-widest text-[#FFC700]">
                    MotorMedic Pro Official Installation SOP
                  </p>
